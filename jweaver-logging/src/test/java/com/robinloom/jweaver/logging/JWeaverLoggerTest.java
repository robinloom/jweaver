...
public class JWeaverLoggerTest {
    ...
    Logger LOGGER_BY_CLASS_TREE = LoggerFactory.getLogger(JWeaverLoggerTest.class, JWeaver.getTree());
    Logger LOGGER_BY_NAME = LoggerFactory.getLogger("Test");
    Logger LOGGER_BY_NAME_BULLET = LoggerFactory.getLogger("Test", JWeaver.getBullet());
